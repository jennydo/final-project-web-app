        ...
        <li className={'list-group-item'}>
            {
                ...
                currentUser._id === u.author._id &&
                <h5><i className="bi bi-pencil-fill float-end" onClick={() => setEditable(!editable)}></i></h5>
            }
                ...
                editable ?
                    <>
                        <Form.Control className={'mb-2 mt-2'}
                                      ...
                                      value={editComment}
                        />
                        <Button variant={'primary'} className={'me-2'} onClick={updateCommentHandle}>Update</Button>
                        <Button variant={'danger'} className={'me-2'} onClick={deleteCommentHandle}>Delete</Button>
                        <Button variant={'secondary'} onClick={() => setEditable(false)}>Cancel</Button>
                    </>
                        :
                    <p>{u.review}</p>
            }
