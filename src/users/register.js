...
const Register = () => {
    ...
    return(
        <>
            ...
            <Alert variant="danger" onClose={() => setErrorRegisterAlert(false)} className={errorRegister ? 'd-block' : 'd-none'} dismissible>
            ...
            <Form>
                ...
                <Form.Group className="mb-3" controlId="registerUsername">
                    ...
                    <Form.Text className={'text-muted'}>Please enter a unique username. Username cannot be changed later on!</Form.Text>
                </Form.Group>
